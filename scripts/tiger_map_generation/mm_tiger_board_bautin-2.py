...
for inverted in [False, True]:
  ...
  for connector_type in ['l', 'c', 'r']: # 'l', 'c', 'r'
    ...
    with open(f'mm_tiger_board_bautin-2_template_{connector_type}{inv_name}.txt', 'w') as f:
      print(f'# tigers connected to {desc} connector of MM{mm} with B2-board{inv_text}', file=f)
